...
$! Fortunately MAKE does not trip most of these issues, so those steps
...
$!---------------------------------------------------------------------
$ open/read flst sys$disk:[.vms]pcsi_make_file_list.txt
$!
$inst_alias_loop:
...
$! remove aliases
$   line_out = -
       "  ""@pcsi$destination:[gnv.vms_bin]make_alias_setup.com remove"""
$   i = 0
$ex_rem_loop:
...
$       write pdsc line_out
$   endif
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]remove_old_make.com"","
$   write pdsc line_out
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]make_alias_setup.com"""
$   i = 0
$ex_pins_loop:
$       line = f$element(i, ",", add_alias_lines)
$       i = i + 1
...
$ write pdsc "     source [vms_bin]gnv$make_startup.com ;"
$!
$!   Add Release notes file.
$!------------------------------
$ write pdsc -
