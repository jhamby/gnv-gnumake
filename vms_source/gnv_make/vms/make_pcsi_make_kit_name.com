$! File: make_pcsi_make_kit_name.com
$!
...
$!
$!
$! We need to get the version from config.ami.  It will have a lines like
$! #define VERSION 3.78.1
$!
$!
$open/read/error=version_loop_end verf config.ami
$version_loop:
