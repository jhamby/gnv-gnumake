...
$!
$! By default:
$!    The source directory is source_root:[gnv_make.reference.gnv_make],
$!    the logical used on my system for the GNV Mecurial repository checkout.
$!    If source_root: is not defined, then src_root:[gnv_make] will be
$!    translated to something like DISK:[dir.gnv_make.reference.gnv_make]
$!    and then DISK:[dir.gnv_make.vms_source.gnv_make] will be used.
$!
$!    The copy directory is vms_root:[gnv_make]
...
$!     The source directory tree is: src_root:[gnv_make]
$!     The copy directory is src_root1:[gnv_make]
$!
$!   src_root1:[gnv_make] is used by me to work around that VMS backup will
...
$!    The source directory is vms_root:[gnv_make]
$!    The copy directory is vms_root1:[gnv_make]
$!
$!   vms_root:
$!   src_root1:[gnv_make] is used by me to work around that VMS backup will
$!   not use NFS as a source directory so I need to make a copy.
...
$if p1 .eqs. "SRCBCK"
$then
$   ref_base_dir = "gnv_make"
$   wrk_base_dir = "gnv_make"
$   ref = "src_root:[" + ref_base_dir
$   wrk = "src_root1:[" + wrk_base_dir
$   if update_file
$   then
$       if f$search("src_root1:[000000]gnv_make.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed src_root1:[gnv_make]
$       endif
$   endif
$endif
$!
...
$   if update_file
$   then
$       if f$search("vms_root1:[000000]gnv_make.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed vms_root1:[gnv_make]
$       endif
$   endif
$endif
$!
...
$  if ref_fname .eqs. "build_w32.bat" then ref_skip = 1
$!
$!
$  if ref_skip .ne. 0
$  then
