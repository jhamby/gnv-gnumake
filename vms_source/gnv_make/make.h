...
#  define strieq(a, b)   \
    ((a) == (b) || \
    (tolower(*(a)) == tolower(*(b)) && (*(a) == '\0' || !strcasecmp ((a) + 1, (b) + 1))))
# else
...
#if defined(VMS) || defined(WINDOWS32)
...
#ifdef VMS
# ifndef EXIT_FAILURE
#  define EXIT_FAILURE (!unixy_shell ? 3 : 2)
# endif
# ifndef EXIT_SUCCESS
#  define EXIT_SUCCESS (!unixy_shell ? 1 : 0)
# endif
# ifndef EXIT_TROUBLE
#  define EXIT_TROUBLE (!unixy_shell ? 2 : 1)
# endif
#else
# ifndef EXIT_FAILURE
